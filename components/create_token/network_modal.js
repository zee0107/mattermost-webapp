    ...
    return(
        <>
            <div className='d-flex'>
                <div className='col-md-6 text-center' data-dismiss='modal' onChange={switchNetwork('1')}>
                    <div className='box-choose-network'>
                    <img className='img-fluid' width='40' src={EthImg} alt=''/>
                    <p className='mt-3 text-white'>Ethereum</p>
                    </div>
                </div>
                <div className='col-md-6 text-center' data-dismiss='modal' onChange={switchNetwork('2')}>
                    <div className='box-choose-network'>
            ...
            <div className='d-flex'>
                <div className='col-md-6 text-center' data-dismiss='modal' onChange={switchNetwork('137')}>
                    <div className='box-choose-network'>
            ...
            <div className='d-flex'>
                ...
                <div className='col-md-6 text-center' data-dismiss='modal' onChange={switchNetwork('80001')}>
                    <div className='box-choose-network'>
                    <img className='img-fluid' width='40' src={MaticImg} alt=''/>
