    ...
    return (
        <>
            {!active ? (
                ...
                <a onClick={disconnect} className='onLockbuttoncreate float-end mr-1'><small><i className='bi bi-person-fill' title={getBalance}></i>{truncateAddress(account)}</small></a>
            )}
        </>
    );
}