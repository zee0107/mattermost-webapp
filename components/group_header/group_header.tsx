                ...
                <div className='col-md-12 chat-box mtop-10'>
                    <div className='row mt-2'>
                        ...
                        <div className='col-md-5'>
                            ...
                            <button className='btn buttonBgGreen text-white float-end btn-sm mr-2' type='button' onClick={this.handleSubmit}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#fff" className="bi bi-images" viewBox="0 0 16 16">
