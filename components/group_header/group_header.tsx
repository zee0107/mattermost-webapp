            ...
            <div>
                <div className='col-md-12 group-cover-box mtop-10 p-0'>
                    ...
                    <div className='col-md-12'>
                        ...
                        <a href='#' onClick={() => {this.setState({uploadImage: true})}} className='float-end btn-sm mt-4' title='Upload Group cover photo'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="var(--text-primary)" className="bi bi-images" viewBox="0 0 16 16">
