                ...
                <div className='container-fluid'>
                    <div className='d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start'>
                        ...
                        <div className='dropdown'>
                                ...
                                <img width='25' className='img-fluid user-photo' src='assets/images/sample-user-primary-picture.png' alt='User name' title='Username'/> Crypter User <i className='bi bi-chevron-down'></i>
                                </button>
