...
const RightControlsStyle = ({productId = null}: Props): JSX.Element => {
    ...
    return (
        <RightControlsContainer>
            ...
            <a href="/messages" className="bg-icons" data-toggle='modal' data-target='#offcanvasRightLabelfriendsdesktop'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="var(--text-primary)" className="bi bi-person-plus menu-align" viewBox="0 0 16 16">
