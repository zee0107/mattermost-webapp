...
const RightControlsStyle = ({productId = null}: Props): JSX.Element => {
    ...
    return (
        <RightControlsContainer>
            ...
            <a href="/messages" className="bg-icons"  data-toggle='offcanvas' data-target='#offcanvasRightLabelfriendsdesktop'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="var(--text-primary)" className="bi bi-person-plus menu-align" viewBox="0 0 16 16">
            ...
            <div style={{ zIndex: 999,}} className='offcanvas offcanvas-end shadow-lg' data-bs-scroll='true' data-bs-backdrop='false' tabIndex='-1' id='offcanvasRightLabelfriendsdesktop' aria-labelledby='offcanvasRightLabelfriendsdesktop'>
