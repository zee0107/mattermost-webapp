    ...
    return (
        <>
            <RightControlsContainer>
                ...
                <a href="#offcanvasRightLabelfriendsdesktop" className="bg-icons"  data-bs-toggle='offcanvas' aria-controls='offcanvasRightLabelfriendsdesktop' role='button'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="var(--text-primary)" className="bi bi-person-plus menu-align" viewBox="0 0 16 16">
