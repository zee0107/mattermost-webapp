...
const RightControlsStyle = ({productId = null}: Props): JSX.Element => {
    ...
    return (
        <RightControlsContainer>
            ...
            <a href="#" className="bg-icons"  data-bs-toggle='offcanvas' data-bs-target='#offcanvasRightLabelfriendsdesktop'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="var(--text-primary)" className="bi bi-person-plus menu-align" viewBox="0 0 16 16">
