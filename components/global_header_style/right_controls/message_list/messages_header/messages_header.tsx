    ...
    render= (): JSX.Element => {
        ...
        renderView = (
            <>
                ...
                <a onClick={() => this.handleChangeSelected('')} className='text-reset' aria-label='Close' data-bs-dismiss='offcanvas' data-bs-toggle='offcanvas' data-bs-target='#offcanvasRightLabelchatdesktop'><i className='bi-list-nested'></i></a>
            </>
        );
