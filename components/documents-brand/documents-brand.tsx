...
export default class DocumentsBrand extends React.PureComponent<Props, State> {
                                ...
                                <div className='position-sticky float-right-panel'>
                                    <div className='box-left-panel-introduction'>
                                        ...
                                        <ul className='list-group mt-2'>
                                            ...
                                            <li className='list-group-item border-0 mb-0'><a href='/documents/brand-assets' className='active-docs text-dark'><label>Brand Assets</label></a></li>
                                        </ul>
                                        <br/>
                            ...
                            <div className='col-md-8'>
                                <div className='position-sticky float-right-panel'>
                                    <div className='launchpad-token-lock-info'>
                                        <div className='row'>
                                            <div className='col-8'><h4 className='float-start mt-3'>Brand Assets</h4></div>
                                    ...
                                    <div className='row mt-2 mb-2'>
                                        <div className='col-6'>
                                            <a href='/documents/presale-support' className='onPreviewskycaudit text-dark'>
                                                <div className='launchpad-token-body-kyc-audit'>
                                                <p><small className='ms-4'>Previous</small></p>
                                                <p className='kyc-previews'>
                                                <i className='bi-arrow-left bi-arrow-left-previews-style'></i><strong><large className='ms-2'>Presale Support</large></strong></p>
                                            </div>
                                            </a>
                                        </div>
                                        <div className='col-6'>
                                            <a href='/documents/create-a-standard-token' className='onNextkycaudit text-dark'>
                                                <div className='launchpad-token-body-kyc-audit'>
                                                <p className='text-end'><small className='me-4'>Next</small></p>
                                                <p className='kyc-previews text-end'>
                                                <strong><large className='ms-2'>Create a Standard Token</large></strong>
                        ...
                        <div className='row'>
                            <div className='col-md-12'>
                                ...
                                <div className='box-middle-panel-products-mobile'>
                                    ...
                                    <div className='launchpad-token-lock-info'>
                                        <div className='row'>
                                            <div className='col-12'><h6 className='float-start mt-3'>Brand Assets</h6></div>
                                        </div>
                                    </div>
                                    <div className='launchpad-token-body'>
                                        <hr/>
