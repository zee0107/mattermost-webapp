...
export class FileUploadNew extends PureComponent {
    static propTypes = {
                ...
                <div>
                    ...
                    <MenuWrapper>
                        ...
                        >
                            <div
                                id='fileUploadButton'
                                className='icon icon--attachment width-100'
                            >
                                <CameraIcon className='d-flex'/> Select file to upload.
                            </div>
                        </button>
                        <Menu
...
const wrappedComponent = injectIntl(FileUploadNew, {forwardRef: true});
wrappedComponent.displayName = 'injectIntl(FileUploadNew)';
