...
import viewPool from 'images/docs/launchpad/view-pool-my-launchpad.png';
import ownerZone from 'images/docs/launchpad/owner-zone-3.png';
...
export default class DocumentsUpdateLaunchpad extends React.PureComponent<Props, State> {
                                ...
                                <div className='position-sticky float-right-panel'>
                                    <div className='box-left-panel-introduction'>
                                        ...
                                        <ul className='list-group mt-2'>
                                            ...
                                            <li className='list-group-item border-0 mb-0'><a href='/documents/update-a-launchpad' className='active-docs fw-bold text-dark'><label>Update a Launchpad</label></a></li>
                            ...
                            <div className='col-md-8'>
                                <div className='position-sticky float-right-panel'>
                                    <div className='launchpad-token-lock-info'>
                                        <div className='row'>
                                            <div className='col-8'><h4 className='float-start mt-3'>Update a Launchpad</h4></div>
                                        ...
                                        <div className='launchpad-kyc-audit'>
                                            <div className='row p-2'>
                                                <div className='col-12 mt-0 mb-1'>
                                                    <p>You can view and change some basic information about your Launchpad through these steps:</p>
                                                </div>
                                                <div className='col-12 mt-0 mb-1'>
                                                    <h6>Step 1: Verify Token</h6>
                                                    <p>1. Go to this link <a>https://www.cryptersale.finance/#/launchpad</a> - My Launchpad – View Pool.</p>
                                                </div>
                                                <div className='col-12 mt-0 mb-1 text-center'>
                                                    <p><img className='img-fluid' src={viewPool} /></p>
                                                </div>
                                                <div className='col-12 mt-0 mb-1'>
                                                    <p>2. Click on the button in the red square shown in the image below.</p>
                                                </div>
                                                <div className='col-12 mt-0 mb-1 text-center'>
                                                    <p><img className='img-fluid' src={ownerZone} /></p>
                                                </div>
                                                <div className='col-12 mt-0 mb-1'>
                                                    <p>3. You can edit the following fields: Logo URL, Website, Facebook, Twitter, Github, Telegram, Reddit and Launchpad description. Some important notes concerning these sections:</p>
                                                    <p><i className='bi-dot'></i> Logo URL must end with a supported image extension: png, jpg, jpeg or gif. For example: <a className='text-primary'>https://www.Crypterswap.finance/Crypterswap.png</a></p>
                                                    <p><i className='bi-dot'></i> Logo URL and website are required fields, these cannot be blank.</p>
                                                    <p>An example:</p>
                                                </div>
                                                <div className='col-12 mt-0 mb-1 text-center'>
                                                ...
                                                <div className='col-12 mt-0 mb-1'>
                                                    <p>4. Click on “Update” after you are done editing. MetaMask will now ask you to confirm the transaction. It will also show you the fee that you are required to pay for that transaction. If you agree, then click on the “Confirm” button to finish the process.</p>
                                                </div>
                                                <div className='col-12 mt-0 mb-1 text-center'>
                                    ...
                                    <div className='row mt-2 mb-2'>
                                        <div className='col-6'>
                                            <a href='/documents/create-a-launchpad' className='onPreviewskycaudit text-dark'>
                                                <div className='launchpad-token-body-kyc-audit'>
                                                <p><small className='ms-4'>Previous</small></p>
                                                <p className='kyc-previews'>
                                                <i className='bi-arrow-left bi-arrow-left-previews-style'></i><strong><large className='ms-2'>Create a Launchpad</large></strong></p>
                                            </div>
                                            </a>
                                        </div>
                                        <div className='col-6'>
                                            <a href='/documents/finalize-a-launchpad' className='onNextkycaudit text-dark'>
                                                <div className='launchpad-token-body-kyc-audit'>
                                                <p className='text-end'><small className='me-4'>Next</small></p>
                                                <p className='kyc-previews text-end'>
                                                <strong><large className='ms-2'>Finalize a Launchpad</large></strong>
                                ...
                                <div className='box-middle-panel-products-mobile'>
                                    ...
                                    <div className='collapse' id='collapseKycmenu'>
                                        <div className='box-left-panel-introduction'>
                                            ...
                                            <ul className='list-group mt-2'>
                                                <li className='list-group-item border-0 mb-0'><a href='/documents/create-a-launchpad' className='text-dark'><label>Create a Launchpad</label></a></li>
                                                <li className='list-group-item border-0 mb-0'><a href='/documents/update-a-launchpad' className='active-docs text-dark'><label>Update a Launchpad</label></a></li>
                                                <li className='list-group-item border-0 mb-0'><a href='/documents/finalize-a-launchpad' className='text-dark'><label>Finalize a Launchpad</label></a></li>
                                                <li className='list-group-item border-0 mb-0'><a href='/documents/add-remove-whitelist' className='text-dark'><label>Add/Remove Whitelists</label></a></li>
                                    ...
                                    <div className='launchpad-token-lock-info'>
                                        <div className='row'>
                                            <div className='col-12'><h6 className='float-start mt-3'>Update a Launchpad</h6></div>
                                        </div>
                                    </div>
                                    <div className='launchpad-token-body'>
                                        <hr/>
                                    ...
                                    <div className='row mt-2 mb-2'>
                                        ...
                                        <div className='col-lg-6 mt-2'>
                                            <a href='/documents/finalize-a-laucnhpad' className='onNextkycaudit text-dark'>
                                                <div className='launchpad-token-body-kyc-audit'>
                                                <p className='text-end'><small className='me-4'>Next</small></p>
                                                <p className='kyc-previews text-end'>
                                                <strong><large className='ms-2'>Finalize a Launchpad</large></strong>
