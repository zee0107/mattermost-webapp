...
function makeMapStateToProps() {
    ...
    return (state: GlobalState) => {
        ...
        const currentChannel = Promise.resolve(channelValue).then(value => {return value});
...
export default connect(makeMapStateToProps, mapDispatchToProps)(CreatePostProfile);
