...
import SignupBusiness, {Props, State, Actions} from './signup_business';
...
export default connect(mapStateToProps, mapDispatchToProps)(SignupBusiness as React.ComponentClass<Props, State>);
