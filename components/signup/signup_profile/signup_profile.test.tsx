...
import SignupProfile from 'components/signup/signup_profile/signup_profile';

import {browserHistory} from 'utils/browser_history';
import {PasswordConfig} from 'utils/utils';

describe('components/SignupProfile', () => {
    const requiredProps = {
        location: {
    ...
    test('should match snapshot', () => {
        const wrapper = shallow<SignupProfile>(
            <SignupProfile {...requiredProps}/>,
        );
