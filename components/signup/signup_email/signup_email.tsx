                    ...
                    <div className='row'>
                        ...
                        <div className='col-sm-7'>
                            <div className='signup-team__container padding--less'>
                                ...
                                />
                                <h3>
                                    <a href='/signup_index' className='removeTextDecor'><svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" fill="#000" className="bi bi-chevron-left" viewBox="0 0 16 16">
