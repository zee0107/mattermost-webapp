...
import SignupIndex, {Props, State, Actions} from './signup_index';
...
export default connect(mapStateToProps, mapDispatchToProps)(SignupIndex as React.ComponentClass<Props, State>);
