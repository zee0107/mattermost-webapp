                ...
                <div className='create-text-story-box'>
                    <div className='form-floating'>
                        ...
                        <div className='row'>
                                ...
                                <div className='col-1 border border-3 text-center bg-info text-white p-3 rounded-circle mt-1 ml-1' onClick={() => { this.onChangeBackground('#fc0303')}} style={{backgroundColor: '#fc0303',}}></div>
                                <div className='col-1 border border-3 text-center bg-danger text-white p-3 rounded-circle mt-1 ml-1' onClick={() => { this.onChangeBackground('#ffff00')}} style={{backgroundColor: '#ffff00',}}></div>
                                <div className='col-1 border border-3 text-center bg-danger text-white p-3 rounded-circle mt-1 ml-1' onClick={() => { this.onChangeBackground('#bfff00')}} style={{backgroundColor: '#bfff00',}}></div>
                                <div className='col-1 border border-3 text-center bg-success text-white p-3 rounded-circle mt-1 ml-1' onClick={() => { this.onChangeBackground('#7bff00')}} style={{backgroundColor: '#7bff00',}}></div>
                                <div className='col-1 border border-3 text-center bg-warning text-white p-3 rounded-circle mt-1 ml-1' onClick={() => { this.onChangeBackground('#2fff00')}} style={{backgroundColor: '#2fff00',}}></div>
                                <div className='col-1 border border-3 text-center bg-info text-white p-3 rounded-circle mt-1 ml-1' onClick={() => { this.onChangeBackground('#15b02a')}} style={{backgroundColor: '#15b02a',}}></div>
                                <div className='col-1 border border-3 text-center bg-danger text-white p-3 rounded-circle mt-1 ml-1' onClick={() => { this.onChangeBackground('#0ccc56')}} style={{backgroundColor: '#0ccc56',}}></div>
                                <div className='col-1 border border-3 text-center bg-info text-white p-3 rounded-circle mt-1 ml-1' onClick={() => { this.onChangeBackground('#00fcb5')}} style={{backgroundColor: '#00fcb5',}}></div>
                                <div className='col-1 border border-3 text-center bg-warning text-white p-3 rounded-circle mt-1 ml-1' onClick={() => { this.onChangeBackground('#00ffff')}} style={{backgroundColor: '#00ffff',}}></div>
                                <div className='col-1 border border-3 text-center bg-dsuccess text-white p-3 rounded-circle mt-1 ml-1' onClick={() => { this.onChangeBackground('#00a2ff')}} style={{backgroundColor: '#00a2ff',}}></div>
                                <div className='col-1 border border-3 text-center bg-warning text-white p-3 rounded-circle mt-1 ml-1' onClick={() => { this.onChangeBackground('#006eff')}} style={{backgroundColor: '#006eff',}}></div>
                                <div className='col-1 border border-3 text-center bg-success text-white p-3 rounded-circle mt-1 ml-1' onClick={() => { this.onChangeBackground('#0040ff')}} style={{backgroundColor: '#0040ff',}}></div>
                                <div className='col-1 border border-3 text-center bg-warning text-white p-3 rounded-circle mt-1 ml-1' onClick={() => { this.onChangeBackground('#9608fc')}} style={{backgroundColor: '#9608fc',}}></div>
                                <div className='col-1 border border-3 text-center bg-danger text-white p-3 rounded-circle mt-1 ml-1' onClick={() => { this.onChangeBackground('#dd07f5')}} style={{backgroundColor: '#dd07f5',}}></div>
                                <div className='col-1 border border-3 text-center bg-success text-white p-3 rounded-circle mt-1 ml-1' onClick={() => { this.onChangeBackground('#cf08c1')}} style={{backgroundColor: '#cf08c1',}}></div>
                                <div className='col-1 border border-3 text-center bg-warning text-white p-3 rounded-circle mt-1 ml-1' onClick={() => { this.onChangeBackground('#eb0989')}} style={{backgroundColor: '#eb0989',}}></div>
                                <div className='col-1 border border-3 text-center bg-info text-white p-3 rounded-circle mt-1 ml-1' onClick={() => { this.onChangeBackground('#eb0967')}} style={{backgroundColor: '#eb0967',}}></div>
                                <div className='col-1 border border-3 text-center bg-danger text-white p-3 rounded-circle mt-1 ml-1' onClick={() => { this.onChangeBackground('#0f1270')}} style={{backgroundColor: '#0f1270',}}></div>
                                <div className='col-1 border border-3 text-center bg-info text-white p-3 rounded-circle mt-1 ml-1' onClick={() => { this.onChangeBackground('#a3ab0c')}} style={{backgroundColor: '#a3ab0c',}}></div>
                                <div className='col-1 border border-3 text-center bg-dsuccess text-white p-3 rounded-circle mt-1 ml-1' onClick={() => { this.onChangeBackground('#cf8151')}} style={{backgroundColor: '#cf8151',}}></div>
                                <div className='col-1 border border-3 text-center bg-warning text-white p-3 rounded-circle mt-1 ml-1' onClick={() => { this.onChangeBackground('#87160e')}} style={{backgroundColor: '#87160e',}}></div>
                                <div className='col-1 border border-3 text-center bg-success text-white p-3 rounded-circle mt-1 ml-1' onClick={() => { this.onChangeBackground('#0e8781')}} style={{backgroundColor: '#0e8781',}}></div>
                        </div>
                        </div>
