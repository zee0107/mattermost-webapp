...
export default class DocumentsCrypterSale extends React.PureComponent<Props, State> {
                            ...
                            <div className='col-md-8'>
                                <div className='position-sticky float-right-panel'>
                                    <div className='launchpad-token-lock-info'>
                                        <div className='row'>
                                            <div className='col-8'><h4 className='float-start mt-3'>CrypterSale Calculator</h4></div>
                                            ...
                                            <div className='row p-2'>
                                                <div className='col-12 mt-0 mb-1'>
                                                    <p className='mt-2 mb-2'>
                                                        ...
                                                        <br/>
                                                        <br/>
                                                        <a href='https://docs.google.com/spreadsheets/d/18fLdYhvOI9tMRlKLOhCYZANMOyYP1G6TFJbPoMJuD70/edit?usp=sharing'>https://docs.google.com/spreadsheets/d/</a>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className='row mt-2 mb-2'>
                                        <div className='col-6'>
                                            <a href='/documents/kyc' className='onPreviewskycaudit text-dark'>
                                                <div className='launchpad-token-body-kyc-audit'>
                                                <p><small className='ms-4'>Previous</small></p>
                                                <p className='kyc-previews'>
                                                <i className='bi-arrow-left bi-arrow-left-previews-style'></i><strong><large className='ms-2'>KYC & Audit at CrypterSale</large></strong></p>
                                            </div>
                                            </a>
                                        </div>
                                        <div className='col-6'>
                                            <a href='/documents/youtube-tutorial' className='onNextkycaudit text-dark'>
                                                <div className='launchpad-token-body-kyc-audit'>
                                                <p className='text-end'><small className='me-4'>Next</small></p>
                                                <p className='kyc-previews text-end'>
                                                <strong><large className='ms-2'>Youtube Tutorials</large></strong>
                        ...
                        <div className='row'>
                            <div className='col-md-12'>
                                ...
                                <div className='box-middle-panel-products-mobile'>
                                    ...
                                    <div className='launchpad-token-lock-info'>
                                        <div className='row'>
                                            <div className='col-12'><h6 className='float-start mt-3'>CrypterSale Calculator</h6></div>
                                        </div>
                                    </div>
                                    <div className='launchpad-token-body'>
                                        <hr/>
