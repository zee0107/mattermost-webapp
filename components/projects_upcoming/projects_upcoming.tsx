...
export default class ProjectsUpcoming extends React.PureComponent<Props, State> {
    static defaultProps = {userId: ''}

    constructor(props: Props) {
        super(props);
        this.state = {openUp: false, width: 0, isStatusSet: false, isDark:'light', img_path: homeImage,data: [],tokenType:'standard_token',sysmbol: 'ETH'};
                                ...
                                <div className='col-md-12 project-item-box'>
                                    <div className='d-flex'>
                                        ...
                                        <div className='col-md-9 text-end'>
                                            <label className='text-upcoming small sale-upcoming-box'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#ff8d08" className="bi bi-dot align-svg" viewBox="0 0 16 16">
