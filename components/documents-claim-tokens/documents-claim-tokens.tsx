...
import howTo from 'images/docs/buypresale/how-to-claim-2.png';
...
export default class DocumentsClaimTokens extends React.PureComponent<Props, State> {
                            ...
                            <div className='col-md-2'>
                                <div className='position-sticky float-right-panel'>
                                    <div className='box-left-panel-introduction'>
                                        ...
                                        <ul className='list-group mt-2'>
                                            <li className='list-group-item border-0 mb-0'><a href='/documents/how-to-buy-a-presale' className='fw-bold text-dark'><label>How to Buy a Presale</label></a></li>
                                            <li className='list-group-item border-0 mb-0'><a href='/documents/how-to-claim-tokens' className='active-docs text-dark'><label>How to Claim Tokens</label></a></li>
                            ...
                            <div className='col-md-8'>
                                <div className='position-sticky float-right-panel'>
                                    <div className='launchpad-token-lock-info'>
                                        <div className='row'>
                                            <div className='col-8'><h4 className='float-start mt-3'>How to Claim Tokens</h4></div>
                                        ...
                                        <div className='launchpad-kyc-audit'>
                                            <div className='row p-2'>
                                                <div className='col-12 mt-0 mb-1'>
                                                    <p>After taking part in and purchasing a token on presale, next you'll want to claim your tokens.</p>
                                                    <p>In case the soft cap/hard cap has been reached, you can claim your tokens once the “Claim token” button is available. The amount of tokens that you can claim will also be shown next to the “Claim token” button.</p>
                                                </div>
                                                ...
                                                <div className='col-12 mt-0 mb-1'>
                                                    ...
                                                    <p>Check your wallet balance to see the presale tokens. We recommend that you follow the social media channels of the project to check their updates.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className='row mt-2 mb-2'>
                                        <div className='col-6'>
                                            <a href='/documents/how-to-buy-a-presale' className='onPreviewskycaudit text-dark'>
                                                <div className='launchpad-token-body-kyc-audit'>
                                                <p><small className='ms-4'>Previous</small></p>
                                                <p className='kyc-previews'>
                                                <i className='bi-arrow-left bi-arrow-left-previews-style'></i><strong><large className='ms-2'>How to buy a presale</large></strong></p>
                                            </div>
                                            </a>
                                        </div>
                                        <div className='col-6'>
                                            <a href='/documents/how-to-withdraw-your-contribution' className='onNextkycaudit text-dark'>
                                                <div className='launchpad-token-body-kyc-audit'>
                                                <p className='text-end'><small className='me-4'>Next</small></p>
                                                <p className='kyc-previews text-end'>
                                                <strong><large className='ms-2'>How to Withdraw Your Contribution</large></strong>
