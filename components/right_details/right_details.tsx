...
export default class RightDetails extends React.PureComponent<Props>{
    ...
    renderGraph = () =>{
        if(this.props.symbol === 'BTC'){
            ...
            //return (<iframe src="https://widget.coinlib.io/widget?type=chart&theme=light&coin_id=1209&pref_coin_id=1505" width="100%" height="100%" scrolling="no" marginwidth="0" marginheight="0" frameborder="0" border="0" className='iframe-style'></iframe>);
        }
