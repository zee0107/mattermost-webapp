                    ...
                    <div className='modal-dialog modal-dialog-centered'>
                        <div className='modal-content'>
                            ...
                            <div className='modal-body'>
                                ...
                                <div className='row mt-3'>
                                    {this.state.userLocation && <a className='locationviewpost onUnselectlocation ml-4' onClick={() => {this.setState({userLocation: ''});}}><label className='text-primary'>{this.state.userLocation} <i className='bi-x-lg'></label></i></a>}
                                </div>
