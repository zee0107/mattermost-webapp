                                        ...
                                        <div className='d-flex'>
                                            <div className='col-lg-4'>
                                                <div className='d-flex'>
                                                    ...
                                                    <div className='col-sm-3'>
                                                        <a href='#' title='Group Chat'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="var(--text-primary)" class="bi bi-people" viewBox="0 0 16 16">
                                            ...
                                            <div className='col-lg-4 text-end'>
                                                <h4><a href='#' title='Settings'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="var(--text-primary)" class="bi bi-gear" viewBox="0 0 16 16">
