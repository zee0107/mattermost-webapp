...
import DocumentsFinalizeLaunchpad from './documents-finalize-launchpad'
...
export default connect(makeMapStateToProps, mapDispatchToProps)(DocumentsFinalizeLaunchpad);
