...
export default class AlbumCover extends React.PureComponent<Props, State> {
    ...
    getImage = async () => {
        ...
        const response = await fetch(`http://95.111.219.126/api/crypter/albumfile?id=${albumId}&filename=${fileName}`);
