...
export default class LaunchPad extends React.PureComponent<Props, State> {
    ...
    componentDidMount(){
        ...
        fetch('https://pro-api.coinmarketcap.com/v1/cryptocurrency/listings/latest', { method: "GET", mode: "no-cors", headers: { "X-CMC_PRO_API_KEY" : "5b439fd8-90e5-467c-b61a-c586252c7e2c", "Accept": "application/json"} })
