                                        ...
                                        <div className='col-sm-12'>
                                            <div className='sidemenuBox'>
                                                <ul className='ul-collapse'>
                                                    <li><a href='#' className='sidemenu-item1'><svg width="23" height="23" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <li><a href='#' className='sidemenu-item2'>Albums</a></li>
                                                    <li><a href='#' className='sidemenu-item3'>My Groups</a></li>
                                                    <li><a href='#' className='sidemenu-item1'>
