...
import LoggedInHFTFNS from 'components/header_footer_template/header_footer_login';

describe('components/LoggedInHFTFNS', () => {
    ...
    test('should match snapshot with help link', () => {
        const wrapper = shallow(
            <LoggedInHFT config={{HelpLink: 'http://testhelplink'}}/>,
        );
        expect(wrapper).toMatchSnapshot();
    });
    ...
    test('should match snapshot with term of service link', () => {
        const wrapper = shallow(
            <LoggedInHFT config={{TermsOfServiceLink: 'http://testtermsofservicelink'}}/>,
        );
        expect(wrapper).toMatchSnapshot();
    });
    ...
    test('should match snapshot with privacy policy link', () => {
        const wrapper = shallow(
            <LoggedInHFT config={{PrivacyPolicyLink: 'http://testprivacypolicylink'}}/>,
        );
        expect(wrapper).toMatchSnapshot();
    });
    ...
    test('should match snapshot with about link', () => {
        const wrapper = shallow(
            <LoggedInHFT config={{AboutLink: 'http://testaboutlink'}}/>,
        );
        expect(wrapper).toMatchSnapshot();
    });
    ...
    test('should set classes on body and #root on mount', () => {
        ...
        shallow(<LoggedInHFT config={{AboutLink: 'http://testaboutlink'}}/>);
