...
import CommentedOn from 'components/post_view_all/commented_on/commented_on';
import CommentedOnFilesMessage from 'components/post_view_all/commented_on_files_message';

describe('components/post_view_all/CommentedOn', () => {
    const baseProps = {
