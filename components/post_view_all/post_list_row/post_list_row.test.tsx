...
import CombinedUserActivityPost from 'components/post_view_all/combined_user_activity_post';
import Post from 'components/post_view_all/post';
import DateSeparator from 'components/post_view_all/date_separator';
import NewMessageSeparator from 'components/post_view_all/new_message_separator/new_message_separator';
import ChannelIntroMessage from 'components/post_view_all/channel_intro_message/';

import {PostListRowListIds} from 'utils/constants';

import PostListRow from './post_list_row';

describe('components/post_view_all/post_list_row', () => {
    const defaultProps = {
        listId: '1234',
