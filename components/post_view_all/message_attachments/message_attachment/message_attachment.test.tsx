...
import MessageAttachment from 'components/post_view_all/message_attachments/message_attachment/message_attachment';

describe('components/post_view_all/MessageAttachment', () => {
    const attachment = {
        pretext: 'pretext',
