...
import ActionButton from 'components/post_view_all/message_attachments/action_button/action_button';

describe('components/post_view_all/message_attachments/action_button.jsx', () => {
    const baseProps = {
