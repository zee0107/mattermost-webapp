...
import PostAddChannelMember, {Props} from 'components/post_view_all/post_add_channel_member/post_add_channel_member';
...
describe('components/post_view_all/PostAddChannelMember', () => {
