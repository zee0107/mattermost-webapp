                    ...
                    <div className='container-fluid'>
                        <div className='d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start'>
                            ...
                            <div className='text-end'>
                                ...
                                <a className='position-relative onDekstopaddfriends' data-toggle='offcanvas' data-bs-target='#offcanvasRightLabelfriendsdesktop' aria-controls='offcanvasRightLabelfriendsdesktop'>
                                ...
                                <a className='position-relative onDekstopaddmessages' data-toggle='offcanvas' data-bs-target='#offcanvasRightLabelchatdesktop' aria-controls='offcanvasRightLabelchatdesktop'>
                                ...
                                <a className='position-relative onDekstopaddnotifications' data-toggle='offcanvas' data-bs-target='#offcanvasRightnotificationdesktop' aria-controls='offcanvasRightnotificationdesktop'>
