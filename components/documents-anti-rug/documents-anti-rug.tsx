...
export default class DocumentsAntiRug extends React.PureComponent<Props, State> {
                                ...
                                <div className='position-sticky float-right-panel'>
                                    <div className='box-left-panel-introduction'>
                                        ...
                                        <ul className='list-group'>
                                            ...
                                            <li className='list-group-item border-0 mb-0'><a href='/documents/anti-rug-system' className='active-docs fw-bold text-dark'><label>Anti-Rug System</label></a></li>
                            ...
                            <div className='col-md-8'>
                                <div className='position-sticky float-right-panel'>
                                    <div className='launchpad-token-lock-info'>
                                        <div className='row'>
                                            <div className='col-8'><h6 className='float-start mt-3'>Anti-Rug System</h6></div>
                                            ...
                                            <div className='row p-2'>
                                                <div className='col-12 mt-0 mb-1'>
                                                    <p className='mt-2 mb-2'>
                                                        There is a vesting system to ask project owners to lock team tokens. So there are no unlocked tokens for rugpull. Buyers are safe at CrypterSale.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className='row mt-2 mb-2'>
                                        <div className='col-6'>
                                            <a href='/documents/token-utility' className='onPreviewskycaudit text-dark'>
                                                <div className='launchpad-token-body-kyc-audit'>
                                                <p><small className='ms-4'>Previous</small></p>
                                                <p className='kyc-previews'>
                                                <i className='bi-arrow-left bi-arrow-left-previews-style'></i><strong><large className='ms-2'>Token Utility</large></strong></p>
                                            </div>
                                            </a>
                                        </div>
                                        <div className='col-6'>
                                            <a href='/documents/partnership' className='onNextkycaudit text-dark'>
                                                <div className='launchpad-token-body-kyc-audit'>
                                                <p className='text-end'><small className='me-4'>Next</small></p>
                                                <p className='kyc-previews text-end'>
                                                <strong><large className='ms-2'>Partnership</large></strong>
                        ...
                        <div className='row'>
                            <div className='col-md-12'>
                                ...
                                <div className='box-middle-panel-products-mobile'>
                                    ...
                                    <div className='launchpad-token-lock-info'>
                                        <div className='row'>
                                            <div className='col-12'><h6 className='float-start mt-3'>Anti-Rug System</h6></div>
                                        </div>
                                    </div>
                                    <div className='launchpad-token-body'>
                                        <hr/>
