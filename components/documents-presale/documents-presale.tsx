...
export default class DocumentsPresale extends React.PureComponent<Props, State> {
                                ...
                                <div className='position-sticky float-right-panel'>
                                    <div className='box-left-panel-introduction'>
                                        ...
                                        <ul className='list-group mt-2'>
                                            ...
                                            <li className='list-group-item border-0 mb-0'><a href='/documents/presale-support' className='active-docs text-dark'><label>Presale Support</label></a></li>
                            ...
                            <div className='col-md-8'>
                                <div className='position-sticky float-right-panel'>
                                    <div className='launchpad-token-lock-info'>
                                        <div className='row'>
                                            <div className='col-8'><h4 className='float-start mt-3'>Presale Support</h4></div>
                                        ...
                                        <div className='launchpad-kyc-audit'>  
                                            <div className='row p-2'>
                                                <div className='col-12 mt-0 mb-1'>
                                                    <p>If you need support for creating a presale on CrypterSale, please contact our support team on Telegram:</p>
                                                </div>
                                                <div className='col-12 mt-0 mb-1'>
                                                    <p><a><i className='bi-dot'></i> @babyCrypterCrypter - KYC, Audit</a></p>
                                                    <p><a><i className='bi-dot'></i> @aussiepip</a></p>
                                                    <p><a><i className='bi-dot'></i> @Seano180</a></p>
                                                    <p><a><i className='bi-dot'></i> @macbeth_1987</a></p>
                                                    <p><a><i className='bi-dot'></i> @EmkoLomsky</a></p>
                                                    <p><a><i className='bi-dot'></i> @yannCrypter</a></p>
                                                    <p><a><i className='bi-dot'></i> @chadmaximus</a></p>
                                                    <p><a><i className='bi-dot'></i> @MicanneS</a></p>
                                                    <p><a><i className='bi-dot'></i> @Ergys5</a></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className='row mt-2 mb-2'>
                                        <div className='col-6'>
                                            <a href='/documents/contact-developers' className='onPreviewskycaudit text-dark'>
                                                <div className='launchpad-token-body-kyc-audit'>
                                                <p><small className='ms-4'>Previous</small></p>
                                                <p className='kyc-previews'>
                                                <i className='bi-arrow-left bi-arrow-left-previews-style'></i><strong><large className='ms-2'>Contact Developers</large></strong></p>
                                            </div>
                                            </a>
                                        </div>
                                        <div className='col-6'>
                                            <a href='/documents/brand-assets' className='onNextkycaudit text-dark'>
                                                <div className='launchpad-token-body-kyc-audit'>
                                                <p className='text-end'><small className='me-4'>Next</small></p>
                                                <p className='kyc-previews text-end'>
                                                <strong><large className='ms-2'>Brand Assets</large></strong>
                        ...
                        <div className='row'>
                            <div className='col-md-12'>
                                ...
                                <div className='box-middle-panel-products-mobile'>
                                    ...
                                    <div className='launchpad-token-lock-info'>
                                        <div className='row'>
                                            <div className='col-12'><h6 className='float-start mt-3'>Presale Support</h6></div>
                                        </div>
                                    </div>
                                    <div className='launchpad-token-body'>
                                        <hr/>
                                    ...
                                    <div className='row mt-2 mb-2'>
                                        <div className='col-lg-6'>
                                            <a href='/documents/contact-developers' className='onPreviewskycaudit text-dark'>
                                                ...
                                                <p><small className='ms-4'>Previous</small></p>
                                                <p className='kyc-previews'>
                                                <i className='bi-arrow-left bi-arrow-left-previews-style'></i><strong><large className='ms-2'>Contact Developer</large></strong></p>
                                            </div>
                                            </a>
                                        </div>
