                    ...
                    <div className="row">
                        ...
                        <div className="col-sm-7">
                            <div className='signup-team__container'>
                                ...
                                />*/}
                                <h3>
                                    <a href='/login' className='removeTextDecor'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="white" className="bi bi-chevron-left" viewBox="0 0 16 16">
