...
export class DotMenuMessage extends React.PureComponent<Props, State> {
            ...
            <MenuWrapper onToggle={this.handleDropdownOpened}>
                ...
                >
                    <button
                        ...
                        className={classNames('post-menu__item float-end', {
                ...
                >
                    ...
                    <Menu.ItemAction
                        ...
                        text={Utils.localizeMessage('edit', 'Edit Post')}
                        onClick={this.handleEditMenuItemActivated}
                    />
                    <Menu.ItemAction
                        id={`delete_post_${this.props.post.id}`}
                        show={this.state.canDelete}
                        text={Utils.localizeMessage('del', 'Remove Post')}
